# -*- coding: utf-8 -*-
"""
Created on Tue Dec 17 11:25 2024
...
with open("data_large_multiTW_diff.txt", "r") as f:          # Open Li & Lim PDPTW instance definitions
    data = f.readlines()        
...
yc = VRP[valid_nodes, 2]

nodes = VRP[valid_nodes, 0]
N = VRP[:, 0]
n = len(nodes)
...
C = 200 #capacity of each vehicle

d = VRP[valid_nodes, 3]

ST = VRP[valid_nodes, 4]
...
for j in valid_nodes:
    k = VRP[j, 5]  # Number of time windows
